...
tellraw @s ["",{"text":"[ »» ]","color":"green","clickEvent":{"action":"open_url","value":"https://bit.ly/3T1qzV7"},"hoverEvent":{"action":"show_text","contents":["",{"translate":"Click to follow link","color":"gold"}]}}," ",{"translate":"Full documentation on how to use the Config Menu"}]
