...
tellraw @s {"color":"aqua","italic":false,"translate":"","extra":[{"text":" "},{"text":"/function minecraft:config_menu","clickEvent":{"action":"suggest_command","value":"/function minecraft:config_menu"}}]}
tellraw @s {"text":" "}
